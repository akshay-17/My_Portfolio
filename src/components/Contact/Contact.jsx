    ...
    <div className="section-container">
      ...
      <div className="contact-form-container">
        <form
          ...
          action="https://formspree.io/f/mqkwbpbk"
          method="POST"
        >
          {/* Email Id Input */}
          <input
      ...
      <div className="social-icons-container">
        <a href="https://github.com/akshay-17" className="social-icon">
          <img src={github} alt="social" />
        </a>
        <a
          href="https://www.linkedin.com/in/akshay-khandelwal-436032143/"
          className="social-icon"
        >
          <img src={linkedin} alt="social" />
        </a>
        <a
          href="https://www.instagram.com/akshay_17_07/"
          className="social-icon"
        >
